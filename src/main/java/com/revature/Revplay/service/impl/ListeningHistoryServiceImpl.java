...
public class ListeningHistoryServiceImpl implements ListeningHistoryService {
    ...
    public List<ListeningHistory> getFullHistory(Long userId) {
        return historyRepository.findByUserIdWithDetails(userId);
    }

    @Override
    public List<ListeningHistory> getArtistHistory(Long artistId) {
        return historyRepository.findByArtistIdOrderByPlayedAtDesc(artistId);
    }
}