...
public class HomeController {
    ...
    public String dashboard(
        ...
        model.addAttribute("trendingSongs", songRepository.findTop6ByOrderByPlayCountDesc());
        model.addAttribute("popularArtists", artistRepository.findTop6ByOrderByFollowerCountDesc());
        model.addAttribute("latestAlbums", albumRepository.findTop6ByOrderByReleaseDateDesc());
        model.addAttribute("podcasts", podcastRepository.findTop6ByOrderByCreatedAtDesc());
        model.addAttribute("playlists", playlistRepository.findTop6ByPrivacy(com.revature.Revplay.entity.PlaylistPrivacy.PUBLIC));
