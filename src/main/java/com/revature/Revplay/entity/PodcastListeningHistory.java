...
public class PodcastListeningHistory {
    ...
    // ✅ FIX: removed insertable=false, updatable=false
    // so playedAt is actually written to DB when saving
    ...
    public PodcastEpisode getEpisode()             { return episode; }
    public void setEpisode(PodcastEpisode episode) { this.episode = episode; }
